...
class Consts:
        ...
        muSun            = 132712440017.987 * 1e9                          # Sun gravitational parameter, [m3/s2]
        ...
        deg2rad          = np.pi/180                                          # conversion from degrees to radians
        rad2deg          = 180/np.pi                                          # conversion from radians to degrees
        ...
        wEarth           = np.array([0, 0, 7.29211514670698e-05])          # Earth angular velocity, [rad/s]
        ...
        goldenRatio               = (1 + np.sqrt(5)) / 2                       # golden ratio, []
