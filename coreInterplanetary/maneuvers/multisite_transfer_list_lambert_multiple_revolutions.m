function [transfers, dV_maps] = multisite_transfer_list_lambert_multiple_revolutions(oe_table, input)
    ...
    for i = 1:input.n_mining_sites   
        ...
        % forward transfers
        dV_map = calculate_dV_map_lambert_multiple_revolutions(oe_colony, oe_mining_site, input);
        ...
        % backward transfers        
        dV_map = calculate_dV_map_lambert_multiple_revolutions(oe_mining_site, oe_colony, input);
